...
const Skills = () => {
  ...
  return <>
      ...
      <AddCategorySelectionModal open={showCategorySelection} onOpenChange={setShowCategorySelection} categories={skillCategories} visibleCategoryIds={visibleCategoryIds} onCategorySelected={handleCategorySelected} />
