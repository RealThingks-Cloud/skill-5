...
import { TrendingUp, TrendingDown, Minus, Target, Award, ChevronRight, Star, Clock, Trophy, Code, Database, Settings, Shield, Zap, Brain, Layers, Cpu, Network, Users } from "lucide-react";
                        ...
                        '--progress-foreground': getProgressGradient(meter.percentage)
                          ...
                          <div className="bg-white/50 rounded-lg p-2">
                            ...
                            <div className="text-xs text-foreground">
                              ...
                              {meter.breakdown.high > 0 && <span className="text-green-600 inline-flex items-center gap-1"><TrendingUp className="h-3 w-3" />High({meter.breakdown.high})</span>}
                              {meter.breakdown.high > 0 && (meter.breakdown.medium > 0 || meter.breakdown.low > 0) && ' • '}
                              {meter.breakdown.medium > 0 && <span className="text-amber-600 inline-flex items-center gap-1"><Minus className="h-3 w-3" />Mid({meter.breakdown.medium})</span>}
                              {meter.breakdown.medium > 0 && meter.breakdown.low > 0 && ' • '}
                              {meter.breakdown.low > 0 && <span className="text-orange-600 inline-flex items-center gap-1"><TrendingDown className="h-3 w-3" />Low({meter.breakdown.low})</span>}
